...
export const ColorPanel = ({selectedColor, setSelectedColor, linewidth, setLinewidth}: ColorPanelProps)=>{
    ...
    return (
        <div className="fixed top-20 left-10 flex items-center bg-[rgb(34,35,40)] p-4  w-fit h-fit rounded-md z-10 mt-10">
            <div className="space-y-4">
                <div className="flex flex-col justify-center gap-2">
                    ...
                    <div className="flex gap-2 items-center ">
                        {Colors.map((color)=>(
                            <button
                            key={color}
                            className={cn("w-6 h-6 rounded-full border-2 cursor-pointer",
                ...
                <div className="flex flex-col justify-center gap-2 ">
                    ...
                    <div className="flex-gap-x-3 items-center flex flex-col-6 cursor-pointer">
